...
export type CreateSubscribleMutationVariables = Exact<{
  name: Scalars['String'];
  email: Scalars['String'];
}>;


export type CreateSubscribleMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };
...
export const CreateSubscribleDocument = gql`
  ...
  createSubscriber(data: {name: $name, email: $email}) {
    ...
    `;
export type CreateSubscribleMutationFn = Apollo.MutationFunction<CreateSubscribleMutation, CreateSubscribleMutationVariables>;

/**
 * __useCreateSubscribleMutation__
 *
 * To run a mutation, you first call `useCreateSubscribleMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateSubscribleMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createSubscribleMutation, { data, loading, error }] = useCreateSubscribleMutation({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useCreateSubscribleMutation(baseOptions?: Apollo.MutationHookOptions<CreateSubscribleMutation, CreateSubscribleMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateSubscribleMutation, CreateSubscribleMutationVariables>(CreateSubscribleDocument, options);
      }
export type CreateSubscribleMutationHookResult = ReturnType<typeof useCreateSubscribleMutation>;
export type CreateSubscribleMutationResult = Apollo.MutationResult<CreateSubscribleMutation>;
export type CreateSubscribleMutationOptions = Apollo.BaseMutationOptions<CreateSubscribleMutation, CreateSubscribleMutationVariables>;
